...
* \`example\`: \`improvement\`에서 지적한 백엔드 아키텍처적 한계를 극복하기 위해, 피평가자가 다음 개발/코드 리뷰/이슈 논의 시 동료들과의 소통에 즉시 복사해서 적용할 수 있는 **[실전 소통 및 기술 적용 템플릿]**을 작성하십시오. 
  - 단순 기술 키워드 나열을 절대 금지합니다.
  - 마크다운 문법(\n, >, * 등)을 적절히 활용하여, 피평가자가 현업에서 바로 쓸 수 있는 대화형 문구, 코드 리뷰 코멘트 템플릿, 또는 의사결정 프레임워크 템플릿 형태로 제공하십시오.
  - 예시: "> **[동시성 검증 제안 백엔드 템플릿]**\n> - **현상**: ... \n> - **아키텍처 제안**: ... \n> - **리뷰어 확인 요청**: ..." 와 같이 구체적인 액션 아이템이 담긴 템플릿 구조여야 합니다.
**응답 JSON 스키마 구조 (순서 및 타입 엄수):**
